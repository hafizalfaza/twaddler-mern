	...
	render(){
		...
		const likeNotification = (<div>
				<div className="media well">
					<div><img src="http://www.synbio.cam.ac.uk/images/avatar-generic.jpg" className="media-object" style={{width: 30, display: "inline-block"}}/>&nbsp;&nbsp;&nbsp;<span><Link to={profileLink}>{triggeredBy}</Link></span> liked this post <img src={love_on} style={{width: 15}} /></div>  
					<div className="media well">
